        ...
        for x in range(border[0], sh[0]-border[0], step):
            ...
            for y in range(border[1], sh[1]-border[1], step):
                for z in range(border[2], sh[2]-border[2], step):
                    ...
                    #mitochondriaProbability = 0.050*0.1 #IEEE paper for cerebellum data
                    #mitochondriaProbability = 0.050*0.3 #BMC Bioinformatics paper for dyntate gyrus, most recent as of Dec 15, 2011
                    #mitochondriaProbability = 0.50 recent test 1
                    mitochondriaProbability = voxelWeightDict['foreground']
                    #NoneProbability = 0.007*0.1 #IEEE paper
                    #NoneProbability = 0.007*0.5 #BMC Bioinformatics paper for dentate gyrus
                    #NoneProbability = 0.007*0.5 #BMC Bioinformatics paper for retina, most recent as of Dec 15, 2011
                    NoneProbability = voxelWeightDict['background']
                    #NoneProbability = 0.07 #Christine's data
                    #NoneProbability = 0.007 #Monica's data, recent test 1

...
mpirun -np $Num_of_processors python sbfsem_batch_mpi.py /home/demo/data/neuropil-read-only/input/40x40 /home/demo/data/neuropil-read-only/data/40x40 /home/demo/data/neuropil-read-only/seg/40x40 /home/demo/temp /mnt/disk2/data/cytoseg_data

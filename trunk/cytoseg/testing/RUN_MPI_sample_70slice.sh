...
mpirun -np $Num_of_processors python ../sbfsem_batch_mpi.py /home/demo/data/neuropil-read-only/input /home/demo/data/neuropil-read-only/data /home/demo/data/neuropil-read-only/seg /home/demo/temp /mnt/disk2/data/cytoseg_data sbfsem_settings1.py
